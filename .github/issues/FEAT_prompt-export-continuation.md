...
## 🔬 VS Code API Research

### Available APIs

| API | Capability | Usable? |
|-----|------------|---------|
| `stream.button()` | Add clickable buttons to chat responses | ✅ Yes |
| `context.history` | Access chat message history | ✅ Yes |
| `vscode.workspace.fs.writeFile()` | Create files programmatically | ✅ Yes |
| Auto-insert into chat input | N/A | ❌ Not available |
| Restore chat history | N/A | ❌ Not available |
